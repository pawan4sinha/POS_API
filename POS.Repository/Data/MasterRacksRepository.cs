...
{
    public class MasterRacksRepository : RepositoryBase<MasterRacks>, IMasterRacksRepository
    {
        RepositoryContext _repositoryContext;

        public MasterRacksRepository(RepositoryContext repositoryContext)
            : base(repositoryContext)
        {
            _repositoryContext = repositoryContext;
            _repositoryContext.MasterRacks.Include(c => c.StoreDetail).ToList();
        }

        public void CreateRack(MasterRacks rec)
        {
            rec.Id = Guid.NewGuid();
        ...
        public MasterRacks GetRackById(Guid id)
        {
        ...
        public List<MasterRacks> GetRackByName(string searchText)
        {
